...
function sendMail() {
  ...
  var emailValue = emailInput.value.trim(); // Remove leading/trailing whitespace

  // Check for an empty email field
  if (emailValue === "") {
    emailInput.style.borderColor = "red";
    emailInput.placeholder = "Email field cannot be empty";
    return; // Exit the function, don't proceed with sending the email
  }

  // Check for invalid email format using a regular expression
  ...
  // Reset the email input style and placeholder
